    ...
    <script text="text/javascript">
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data.status == false) {
                        ...
                        $('#info').empty();
                        $('#info').append('<b>Akses dibatasi! Anda telah melakukan absen WFH!</b>');
                        $('#btn_pagi').attr('disabled', true);
                        $('#btn_pulang').attr('disabled', true);

                        }
                    } else {
                        if (data.pagi != "" && data.pulang == "") {
                            $('#info').empty();
                            $('#info').append('<b>Anda telah melakukan absen pagi</b><br><b>Silahkan melakukan absen pulang!</b>');
        ...
        $('#btn_pulang').click(function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    alert('Berhasil! Sampai jumpa lagi~');
                    setInterval('location.reload()', 100);
                },
                error: function(request) {
                    console.log(request.responseText);
